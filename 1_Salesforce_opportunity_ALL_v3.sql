...
/** PURCHASE SPECIFICS	**/
	...
	/*	/** INTEREST	**/
      opp.[Clock_Options__c],
      opp.[Clock_Purchase__c],
      opp.[Clock_Rental__c],
      opp.[Clocks__c],
*/
...
/**- RECORD DATES OF SALESFORCE.COM ACTIVITY **/
  ...
  /**and Close_Reasons__c not like 'Duplicate Opportunity' **/
  /**AND (StageName = 'Closed Lost' or StageName = 'Closed Won') **/ 
  and DATEDIFF(d,CreatedDate,CloseDate) > 1 
  ...
  /**AND opp.Stage_6_Duration__c >1**/
  /**AND opp.Stage_7_Duration__c >1**/
