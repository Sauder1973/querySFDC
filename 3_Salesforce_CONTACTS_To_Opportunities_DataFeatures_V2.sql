...
*/
	SELECT 
		...
		,contact.[LifeWorks_AE__c]
		,contact.[LifeWorks_Broker__c]
		,contact.[LifeWorks_Rep_DEPRECATED__c]
	...
	--WHERE Email_Has_Bounced__c = 'false'
...
-- REQUIRED TABLE JOINS
  ...
  -- AND (opp.StageName = 'Closed Lost' or opp.StageName = 'Closed Won') -- USE FOR TRAINING ONLY LINE THAT NEEDS TO BE REMOVED
  AND (opp.StageName NOT LIKE 'Closed Lost' or opp.StageName NOT LIKE 'Closed Won') --USE FOR PREDICTION
  ...
  order by opp.[AccountId]--, opp.[CreatedDate]
